...
activities = {
    ...
    "Soccer Training": {
        "description": "Develop soccer skills, teamwork, and game strategy",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Practice yoga, mindfulness, and relaxation techniques",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["isaac@mergington.edu", "zara@mergington.edu"]
    },
    "Math Olympiad": {
